    ...
    >
      ...
      >
        ...
        <Animated.View style={[styles.logoArea, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
          ...
          <Text style={styles.tag}>RESCUE</Text>
        </Animated.View>
...
const styles = StyleSheet.create({
  ...
  boltTop: {
    width: 0, height: 0,
    borderLeftWidth: 8, borderRightWidth: 3, borderBottomWidth: 16,
  ...
  boltBottom: {
    width: 0, height: 0,
    borderLeftWidth: 3, borderRightWidth: 8, borderTopWidth: 16,
    borderLeftColor: 'transparent', borderRightColor: 'transparent',
    borderTopColor: '#00E5FF',
    marginRight: 5, opacity: 0.85,
  },
